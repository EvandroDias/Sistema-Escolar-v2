...
@Component({
  selector: "app-rotina-admin",
  templateUrl: "./rotina-admin.component.html",
  styleUrls: ["./rotina-admin.component.css"],
  providers: [MessageService]
})
export class RotinaAdminComponent extends BaseFormComponent implements OnInit {
